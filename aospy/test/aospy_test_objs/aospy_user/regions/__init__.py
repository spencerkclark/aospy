...
deep_tropics.do_land_mask = False
# Deep tropics.
atlantic = Region()
atlantic.name = 'atlantic'
atlantic.description = 'Atlantic Ocean'
atlantic.do_land_mask = 'ocean'
