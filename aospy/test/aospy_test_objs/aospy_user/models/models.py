...
import aospy_user.runs.am2 as am2_runs
...
am2 = Model(
    ...
    runs=[am2_runs.am2_control],
    default_runs=[am2_runs.am2_control]
)
...
dargan = Model(
    ...
    runs=[idealized.control_T85],
    default_runs=[idealized.control_T85],
)
